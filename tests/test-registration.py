...
class UserRegistrationTestCase(unittest.TestCase):
    ...
    def test_user_registration_without_email(self):
        ...
        register = self.client.post("api/v1/users/", data=json.dumps(dict(username="example", password="1234")), content_type=("application/json"))
        response = json.loads(register.data.decode())
    ...
    def test_user_registration_with_existing_username(self):
        ...
        register = self.client.post("api/v1/users/", data=json.dumps(self.data), content_type=("application/json"))
